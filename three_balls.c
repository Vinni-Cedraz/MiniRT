...
int main() {
    ...
    set_transform((t_sphere *)&floor, scaling);
    ...
    set_transform((t_sphere *)&middle_ball, create_translation_matrix((t_tuple){-0.5, 1, 0.5, POINT}));

	right_ball.material.color = (t_tuple){0.5, 1, 0.1, COLOR};
	right_ball.material.specular = 0.3;
	right_ball.material.diffuse = 0.7;
    set_transform((t_sphere *)&right_ball, mult_matrices(create_translation_matrix((t_tuple){1, 0.5, -0.75, POINT}),
