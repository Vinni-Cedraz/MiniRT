...
int main() {
    ...
    set_transform((t_shape *)&right_ball, mult_matrices(create_translation_matrix((t_tuple){1.15, 0.7, 0.5}),
                                                        create_scaling_matrix(0.5, 0.5, 0.5)));

    set_material((t_tuple){0.1, 0.9, 0.9, 200}, (t_tuple){0.1, 1, 0.1}, &middle_ball.material);
    set_transform((t_shape *)&middle_ball, mult_matrices(create_translation_matrix((t_tuple){0, 0.8, 0.1}),
                                                         create_scaling_matrix(0.7, 0.7, 0.7)));

    set_material((t_tuple){0.1, 0.9, 0.9, 200}, (t_tuple){1, 0.8, 0.1}, &left_ball.material);
    set_transform((t_shape *)&left_ball, mult_matrices(create_translation_matrix((t_tuple){-0.95, 0.33, 0.4}),
