...
// 		{NULL}
// 	});
// 	t_matrix cofact = create_matrix_of_cofactors(m);
...
// 		{NULL}
// 	});
// 	double det = _4x4determinant(m);
// 	t_matrix cofact = create_matrix_of_cofactors(m);
// 	t_matrix trans = transpose_matrix(cofact);
// 	t_matrix res = divide_transposed_matrix_by_determinant(trans , det);
// 	cr_expect_tuples_eq(res.row_1, expected.row_1);
// 	cr_expect_tuples_eq(res.row_2, expected.row_2);
// 	cr_expect_tuples_eq(res.row_3, expected.row_3);
// 	cr_expect_tuples_eq(res.row_4, expected.row_4);
...
// 		{NULL}
// 	});
// 	int det = _4x4determinant(m);
// 	t_matrix result = divide_transposed_matrix_by_determinant(m, det);
