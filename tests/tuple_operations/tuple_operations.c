...
Test(suit_name, adding_two_tuples, .description = test1_description) {
	t_tuple a = {1.2, 2.4, 3.5, 0};
	t_tuple b = {1.2, 2.4, 3.5, 1};
	t_tuple result = {2.4, 4.8, 7.0, 1};
	cr_expect_arr_eq(result, add_tuples(a, b, result), sizeof(t_tuple));
}
