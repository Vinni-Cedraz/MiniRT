...
//          "And light ← point_light(point(0, 0, -10), color(1, 1, 1))\n" \
//          "When result ← lighting(m, light, position, eye_vec, normal_vec)\n" \ "Then
//          result = color(1.0, 1.0, 1.0)" RESET
// Test(phong_reflection, lighting_with_eye_between_light_and_surface_offset_45,
// .description = scenario5) { 	t_lighting lighting_obj = { 		.material = create_material(),
// 		.position = {0, 0, 0, POINT},
// 		.eye_vec = {0, SQRT_2by2, negSQRT_2by2, VECTOR},
// 		.normal_vec = {0, 0, -1, VECTOR},
// 		.light = create_point_light((t_tuple){0, 0, -10, POINT}, (t_tuple){1, 1, 1,
// COLOR}),
// 	};
//
// 	t_tuple result = calculate_lighting(&lighting_obj);
...
//          "When result ← lighting(m, light, position, eye_vec, normal_vec)\n" \ "Then
//          result = color(0.7364, 0.7364, 0.7364)" RESET
// Test(phong_reflection, lighting_with_eye_opposite_surface_light_offset_45, .description
// = scenario6) { 	t_lighting lighting_obj = { 		.material = create_material(), 		.position =
// {0, 0, 0, POINT}, 		.eye_vec = {0, 0, -1, VECTOR}, 		.normal_vec = {0, 0, -1, VECTOR},
// 		.light = create_point_light((t_tuple){0, 10, -10, POINT}, (t_tuple){1, 1, 1,
// COLOR}),
// 	};
//
// 	t_tuple result = calculate_lighting(&lighting_obj);
// 	t_tuple expected_result = {0.7364, 0.7364, 0.7364, COLOR};
// 	cr_expect_tuples_eq(result, expected_result);
// }
//
...
//          "And light ← point_light(point(0, 10, -10), color(1, 1, 1))\n" \
//          "When result ← lighting(m, light, position, eye_vec, normal_vec)\n" \ "Then
//          result = color(1.6364, 1.6364, 1.6364)" RESET
// Test(phong_reflection, lighting_with_eye_in_the_path_of_reflection_vector, .description
// = scenario7) { 	t_lighting lighting_obj = { 		.material = create_material(), 		.position =
// {0, 0, 0, POINT}, 		.eye_vec = {0, negSQRT_2by2, negSQRT_2by2, VECTOR}, 		.normal_vec = {0,
// 0, -1, VECTOR}, 		.light = create_point_light((t_tuple){0, 10, -10, POINT}, (t_tuple){1,
// 1, 1, COLOR}),
// 	};
//
// 	t_tuple result = calculate_lighting(&lighting_obj);
// 	t_tuple expected_result = {1.6364, 1.6364, 1.6364, COLOR};
// 	cr_expect_tuples_eq(result, expected_result);
// }
//
...
//          "And light ← point_light(point(0, 0, 10), color(1, 1, 1))\n" \
//          "When result ← lighting(m, light, position, eye_vec, normal_vec)\n" \ "Then
//          result = color(0.1, 0.1, 0.1)" RESET
...
//
// 	t_tuple result = calculate_lighting(&lighting_obj);
// 	t_tuple expected_result = {0.1, 0.1, 0.1, COLOR};
// 	cr_expect_tuples_eq(result, expected_result);
// }
