...
Test(building_world, the_default_world, .description = scenario2) {
	...
	t_matrix *scaling_matrix = create_scaling_matrix(0.5, 0.5, 0.5);
 	t_matrix *inverse_scaling_matrix = invert_matrix(*scaling_matrix);
...
Test(building_world, shading_intersection, .description = scenario7) {
	...
	t_tuple color;
	t_prep_comps prep_comps;
	t_tuple expected_color = {0.38066, 0.47583, 0.2855, COLOR};
