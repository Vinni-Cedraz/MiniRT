...
{
	t_matrix *transform;
	t_tuple	point = {-4,6,8, POINT};
	t_tuple	result;
	t_tuple	expected = {-8, 18, 32, POINT};
...
{
	t_matrix *transform;
	t_tuple	vector = {-4,6,8, VECTOR};
	t_tuple	result;
	t_tuple	expected = {-8, 18, 32, VECTOR};
...
Test(scaling, scaling_by_negative_value, .description=scenario4)
{
	t_matrix *transform;
	t_matrix *inv;
	t_tuple	point = {2, 3, 4, POINT};
	t_tuple	result;
	t_tuple	expected = {-2, 3, 4, POINT};
